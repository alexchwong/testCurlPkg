...
RcppExport SEXP _testCurlPkg_idxstats_pbam(SEXP bam_fileSEXP, SEXP n_threads_to_useSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_testCurlPkg_idxstats_pbam", (DL_FUNC) &_testCurlPkg_idxstats_pbam, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_testCurlPkg(DllInfo *dll) {
